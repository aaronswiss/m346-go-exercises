...
func main() {
	...
	tim := Person{FullName{"Tim", "Hüsler"}, BirthDate{15, 01, 2008}}
	eneas := Person{FullName{"Eneas", "Infanger"}, BirthDate{1, 3, 2008}}
	phil := Person{FullName{"Phil", "Hägeli"}, BirthDate{10, 3, 2008}}
